...
## abstract
This report provides an prediction model based on the data from accelerometers on the belt, forearm, arm, and dumbell of 6 participants. It's goal is to predict the manner in which they did the exercise. I use random forest as the model for this task. I also use cross validation during trainning.
...
a <- confusionMatrix(p,testing$classe)$overall[1]  
